...
【要件】
- 件名を含める
- 自然な日本語で作成（英語を日本語に訳したような表現は絶対に避ける）
- B2Bマーケティングのセオリーに沿う：
  - 直接的な参加URLは記載しない
  - 申し込みフォームのURLのみを記載
  - 参加者にとっての価値やメリットを明確に
...
- ${surveyFormUrl ? `アンケートフォーム入力URL（${surveyFormUrl}）を記載し、` : ''}アンケートへの協力を丁寧にお願い（ただし押し付けがましくない表現）
        ...
        const [planRes, checklistRes, snsRes, internalRes, marketingRes, thanksRes, reminderRes, thankyouRes] = await Promise.all([
            ...
            openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'あなたはウェビナー社内告知文を作成する専門家です。提供された情報から、これから開催するウェビナーを社内メンバーに告知する文章を自然な日本語で作成してください。'
                    },
                    {
                        role: 'user',
            ...
            openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'あなたはB2Bマーケティングの専門家です。提供された情報から、B2B企業向けのセミナー集客メールを自然な日本語で作成してください。他社のB2Bセミナー集客メールを参考に、英語を日本語に訳したような表現は避けてください。'
                    },
                    {
                        role: 'user',
            ...
            openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'あなたはB2Bマーケティングの専門家です。提供された情報から、B2B企業向けのセミナーリマインドメールを自然な日本語で作成してください。他社のB2Bセミナーリマインドメールを参考に、英語を日本語に訳したような表現は避けてください。'
                    },
                    {
                        role: 'user',
            ...
            openai.chat.completions.create({
                ...
                messages: [
                    {
                        role: 'system',
                        content: 'あなたはB2Bマーケティングの専門家です。提供された情報から、B2B企業向けのセミナー参加者向けお礼メールを自然な日本語で作成してください。他社のB2Bセミナーお礼メールを参考に、英語を日本語に訳したような表現は避けてください。'
                    },
                    {
                        role: 'user',
